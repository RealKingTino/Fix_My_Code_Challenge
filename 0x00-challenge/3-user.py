...
if __name__ == '__main__':
    ...
    if user_1.password != u_pwd:  # Fixed this condition
    ...
    user_2.password = "89"  # Changed to a string to match property type
    if user_2.password is not None:
        print("User.password should be None if set to a string")
    ...
    if user_1.is_valid_password("89"):  # Changed to a string to match property type
        print("is_valid_password should return False if compared with a string")
